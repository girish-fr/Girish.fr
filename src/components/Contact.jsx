...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const SERVICE_ID = 'service_1lm8ohq'; // Replace with actual service ID
    const TEMPLATE_ID = 'template_8mcemwo'; // Replace with actual template ID
    const PUBLIC_KEY = '1c1v11wNfEjiMlSau'; // Replace with actual public key
    ...
    try {
      emailjs
          .send(
              ...
              {
                from_name: form.name,
                to_name: "Girish Chugh",
                from_email: form.email,
                to_email: "girishcard@gmail.com",
